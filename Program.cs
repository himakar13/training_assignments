...
namespace assignment_6
{
    ...
    class InterfaeEg
    {
        static void inteegrfae()
        {

            IStudent obj = new DaySholar();
            obj.DisplayDetails(1, "himakar");


            IStudent obj1 = new Resident();
            obj1.DisplayDetails(2, "himakar");
...
new Employee { EmployeeID = 1001, FirstName = "Malcolm", LastName = "jaswanth", Title = "Manager", DOB =" 16/11/1984",
    DOJ =DateTime.Parse("8/6/2011"), City = "Mumbai" },
new Employee { EmployeeID = 1002, FirstName = "Asdin", LastName = "teja", Title = "AsstManager", DOB = "20/08/1984",
    DOJ =DateTime.Parse("7/7/2012"), City = "Mumbai" },
new Employee { EmployeeID = 1003, FirstName = " Madhavi", LastName = " uma", Title = " Consultant ", DOB = " 14 / 11 / 1987",
    DOJ = DateTime.Parse("12/4 / 2015"), City = "Pune" },
new Employee { EmployeeID = 1004, FirstName = "Saba ", LastName = "sumanth", Title = "SE", DOB = "3 / 6 / 1990",
    DOJ = DateTime.Parse("2 / 2 / 2016"), City = " Pune" },
new Employee { EmployeeID = 1005, FirstName = "  Nazia", LastName = "anjali", Title = "SE", DOB = "8 / 3 / 1991",
    DOJ = DateTime.Parse(" 2 / 2 / 2016"), City = "Mumbai" },
new Employee { EmployeeID = 1006, FirstName = " Amit", LastName = "mano", Title = "Consultant ", DOB = "7 / 11 / 1989",
    DOJ =DateTime.Parse( " 8 / 8 / 2014"), City = " Chennai" },
new Employee { EmployeeID = 1007, FirstName = "Vijay", LastName = "kiran ", Title = "Consultant", DOB = " 2 / 12 / 1989",
    DOJ =DateTime.Parse( "1 / 6 / 2015"), City = "Mumbai" },
new Employee { EmployeeID = 1008, FirstName = "  Rahul", LastName = " hari", Title = " Associate  ", DOB = "11 / 11 / 1993",
    DOJ = DateTime.Parse("6 / 11 / 2014"), City = "Chennai" },
new Employee { EmployeeID = 1009, FirstName = " Suresh", LastName = "ramesh ", Title = " Associate", DOB = "12 / 8 / 1992",
    DOJ = DateTime.Parse("3 / 12 / 2014"), City = "Chennai" },
new Employee { EmployeeID = 1010, FirstName = "  Sumit", LastName = " dileep", Title = "Manager", DOB = "12 / 4 / 1991",
